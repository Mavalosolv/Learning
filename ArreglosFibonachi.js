let parfib=5; // declaracion de variable
...
function fibonacci(param) { // se crea la funcion
    ...
    for(let i=2; i<parfib; i++){  // se declara el ciclo para empezar a interar
...
fibonacci(parfib); //se inicializa la funcion
resultadofib=fibonacci(parfib);//se inicialia la variable que creamos para guardar el resultado con la funcion
